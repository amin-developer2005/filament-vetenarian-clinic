...
return [
    'label' => 'برنامه‌های کاری من',
    'plural_label' => 'برنامه‌های کاری من',
    'singular_label' => 'برنامه کاری من',
    'bread_crumb' => 'برنامه‌های کاری من',
        ...
        'create' => [
            ...
            'form' => [
                'select' => [
                    ...
                    'clinic' => [
                        'no_options_message' => 'شما عضو کلینیکی نیستید.'
                    ],
                ]
            ],
        ],
