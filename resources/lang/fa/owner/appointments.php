...
return [
    'label'         => 'نوبت‌ ها من',
    'plural_label'  => 'نوبت‌ ها من',
    'singular_label'=> 'نوبت',
    'bread_crumb' => 'نوبت‌ ها من',
    ...
    'table' => [
        ...
        'emptyStateHeading' => 'در حال حاضر هیچ نوبت رزروشده‌ای برای شما وجود ندارد.',
        'emptyStateDescription' => 'هنوز هیچ مالک حیوانی برای ساعات کاری امروز شما نوبت رزرو نکرده است.
پس از ثبت اولین نوبت، اطلاعات آن در این بخش نمایش داده خواهد شد.',
    ],
];
