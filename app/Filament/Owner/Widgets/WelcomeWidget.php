...
class WelcomeWidget extends Widget
{
    ...
    public int $myAnimals {
        get => $this->myAnimals ?? 0;
        set => $this->myAnimals = $value;
    }
    ...
    public function getStatsCards(): array
    {
        return [
            ...
            [
                'label' => __('widgets/dashboard.stats.myAnimals.label'),
                'value' => $this->myAnimals,
                'description' => __('widgets/dashboard.stats.myAnimals.description'),
                'borderColor' => 'border-t-rose-500',
                'iconBg' => 'bg-rose-50 dark:bg-rose-500/10',
                'iconColor' => 'text-rose-500 dark:text-rose-400',
                'svg' => '<path stroke-linecap="round" stroke-linejoin="round" d="M9.75 9.75l4.5 4.5m0-4.5l-4.5 4.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />',
    ...
    private function countMyAnimals(): void
    {
        $this->myAnimals = Animal::query()
    ...
    {
        return __('widgets/dashboard.empty_schedule.panel.owner.title');
    }

    public function getEmptyScheduleDescription(): string
    {
        return __('widgets/dashboard.empty_schedule.panel.owner.description');
    }
}
